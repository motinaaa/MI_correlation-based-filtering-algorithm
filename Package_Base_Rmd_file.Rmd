...
X_train = read.csv(file = '../data/X_train_data_stat585.csv', header = FALSE)
X_test = read.csv(file = '../data/X_test_data_stat585.csv', header = FALSE)
y_train = read.csv(file = '../data/y_train_data_stat585.csv', header = FALSE)
y_test = read.csv(file = '../data/y_test_data_stat585.csv', header = FALSE)
