...
correlation_based_filtering = function(X_tarin, y_train, MI_threshold, cor_threshold){
  ...
  # Make a list by features_list and final data set
  final_list = list(x1 = reduced_X_train_final, x2 = features_list)
...
# Test the function, we should implement the above filtering function
```{r}
function_output = correlation_based_filtering(X_train, y_train, MI_threshold = 0.01, cor_threshold = 0.95)
```




# Check the output "final_list" for x1
```{r}
function_output$x1
```
...
# Check the output "final_list" for x2
```{r}
function_output$x2
```


# Select the selected features in "reduced_X_train_final" from the original X_test
